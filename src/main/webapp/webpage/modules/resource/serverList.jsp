...
<head>
	...
	<script type="text/javascript">
			...
			function detail(id){
				var id=id;
				var url='${ctx}/resource/resource/serverDetail?id='+id;             //转向网页的地址;
				var name='';                  //网页名称，可为空;
...
<body>
	...
	<div class="panel-heading">
		<h3 class="panel-title">服务器资源列表</h3>
	</div>
		...
		<div class="col-sm-9 col-md-10" >
			...
			<div id="toolbar">
				<shiro:hasPermission name="resource:resource:add">
					<a id="add" class="btn btn-primary" href="${ctx}/resource/resource/serverForm" title="resource"><i class="glyphicon glyphicon-plus"></i> 添加服务器</a>
				</shiro:hasPermission>
