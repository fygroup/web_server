			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title">
						<a class="panelButton" href="${ctx}/resource/resource/safetyEquipmentList"><i class="ti-angle-left"></i> 返回</a>
					</h3>
				</div>
				<div class="panel-body">
					<form:form id="inputForm" modelAttribute="resource" action="${ctx}/resource/resource/safetyEquipmentFormSave" method="post" class="form-horizontal">
						<form:hidden path="id"/>
                    ...
                    --%>
								<sys:resourceselect id="resourceType" name="resourceType.id" value="${resource.resourceType.id}" labelName="" labelValue="${resource.resourceType.name}"
													title="资源类型" url="/resourcetype/resourceType/treeDataByCode?code=6"  cssClass="form-control required" notAllowSelectParent="true"/>
