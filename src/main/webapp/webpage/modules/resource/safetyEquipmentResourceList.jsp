...
<head>
	...
	<%@include file="safetyResourceList.js" %>
	...
	<script type="text/javascript">
			...
			function detail(id){
				var id=id;
				var url='${ctx}/resource/resource/safetyEquipmentdetail?id='+id;             //转向网页的地址;
				var name='';                  //网页名称，可为空;
...
<body>
	...
	<div class="panel-heading">
		<h3 class="panel-title">安全设备资源列表</h3>
	</div>
		...
		<div class="col-sm-9 col-md-10" >
			...
			<div id="toolbar">
				<shiro:hasPermission name="resource:resource:add">
					<a id="add" class="btn btn-primary" href="${ctx}/resource/resource/safetyEquipmentForm" title="resource"><i class="glyphicon glyphicon-plus"></i> 添加安全设备</a>
				</shiro:hasPermission>
