...
<script>
    ...
    function exportExcel(){
        window.open("${ctx}/resource/resource/exportData?data="+$("#dateValue").val());
    };
    ...
    function init() {
        ...
        $.ajax({
            type : 'GET',
            async : true,
            url :  "${ctx}/resource/resource/getServerCpuChartData",
            data:{data:$("#dateValue").val(),resourceTypeId:"1987289b07894de3b89a78f44d5ee8a9"},
        ...
        $.ajax({
            type : 'GET',
            async : true,
            url :  "${ctx}/resource/resource/getServerMemChartData",
            data:{data:$("#dateValue").val(),resourceTypeId:"1987289b07894de3b89a78f44d5ee8a9"},
            timeout:10*1000,    //超时时间 10s
            success : function(result) {
