...
<head>
	...
	<script type="text/javascript">
        ...
        var virtualTotal;
        var virtualUserd;
        var virtualUsedPercent;

        var physicalTotal;
        var physicalUserd;
        var physicalUsedPercent;
		...
		$(document).ready(function() {
            ...
            $(".virtualValue").each(function (index,obj) {
                if(index==0){
                    virtualTotal=$(this).val()+"GB";
				}else if(index==1){
                    virtualUserd=$(this).val()+"GB";
                }
                else if(index==2){
                    virtualUsedPercent=$(this).val();
                }
            })

            $(".physicalValue").each(function (index,obj) {
                if(index==0){
                    physicalTotal=$(this).val()+"GB";
                }else if(index==1){
                    physicalUserd=$(this).val()+"GB";
                }
                else if(index==2){
                    physicalUsedPercent=$(this).val();
                }
            })
                ...
                <div class="col-sm-12">
                    <div class="tabs-container">
                        <ul class="nav nav-tabs">
                            ...
                            <li class=""><a data-toggle="tab" href="#tab-4" aria-expanded="false">承载业务(0)</a>
                            </li>
                        </ul>
	...
	<%--服务器信息--%>
				...
				<form:form id="informationForm" action="${ctx}/resourceinformation/resourceInformation/edit"  method="post"  class="form-horizontal">
					...
					<input name="resourceId" value="${resource.id}">
						...
						<tr>
							...
							<td class="td-default">采购金额</td><td class="td-hover"><input  name="purchaseSum" id="informationPurchaseSum" class="informationClass" value="${resourceInformation.purchaseSum}" /></td>
						...
						<tr>
							<td class="td-default">维保年限</td><td class="td-hover"><input  name="maintenancePeriod" id="informationMaintenancePeriod" class="informationClass" value="${resourceInformation.maintenancePeriod}" /></td>
						...
						<tr>
							...
							<td class="td-default">数据库端口</td><td class="td-hover"><input  name="dbPort" id="informationDbPort" class="informationClass" value="${resourceInformation.dbPort}" /></td>
		...
		<div class="row">
			...
			<table class="table information-table" id="configInfoFormEdit">
              ...
              <form:form id="configInfoForm" action="${ctx}/resourceconfiginfo/resourceConfigInfo/edit"  method="post"  class="form-horizontal">
							...
							<tr>
								<td class="td-default">CPU 个数</td><td class="td-hover"><input  name="cpuNum" id="configInfoCpuNum" class="configInfoClass" value="${resourceConfigInfo.cpuNum}" /></td>
							...
							<tr>
								<td class="td-default">单个 CPU 核数</td><td class="td-hover"><input  name="singleCpuCorenum" id="configInfoSingleCpuCorenum" class="configInfoClass" value="${resourceConfigInfo.singleCpuCorenum}" /></td>
								...
								<td class="td-default">内存条个数</td><td class="td-hover"><input  name="memoryNum" id="configInfoMemoryNum" class="configInfoClass" value="${resourceConfigInfo.memoryNum}" /></td>
							</tr>
							<tr>
								...
								<td class="td-default">硬盘个数</td><td class="td-hover"><input  name="diskNum" id="configInfoDiskNum" class="configInfoClass" value="${resourceConfigInfo.diskNum}" /></td>
		...
		<div class="row">
			<div class="h-title">
				...
				<div class="pull-right ">
					<button  class="tableEdit" onclick="showPhysicInfoEditView(this)" id="physicInfoEditBtn">编辑</button><!--btn edit -->
				...
				<tbody>
                 <form:form id="physicInfoForm" action="${ctx}/resourcephysicinfo/resourcePhysicInfo/edit"  method="post"  class="form-horizontal">
					...
					<input name="resourceId" value="${resource.id}">
					<tr>
						<td class="td-default">高度(CM)</td><td class="td-hover"> <input  name="height" id="physicInfoHeight" class="physicInfoClass" value="${resourcePhysicInfo.height}" /></td>
						<td class="td-default">功耗(W)</td><td class="td-hover"> <input  name="powerDissipation" id="physicInfoPowerDissipation" class="physicInfoClass" value="${resourcePhysicInfo.powerDissipation}" /> </td>
						<td class="td-default">发热(J)</td><td class="td-hover"><input  name="heat" class="physicInfoClass" id="physicInfoHeat"  value="${resourcePhysicInfo.heat}" /> </td>
					</tr>
					<tr>
						<td class="td-default">重量(KG)</td><td class="td-hover"><input  name="weight" id="physicInfoWeight" class="physicInfoClass" value="${resourcePhysicInfo.weight}" /> </td>
