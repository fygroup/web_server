...
<head>
	...
	<script type="text/javascript">
				...
				submitHandler: function(form){
				    ...
				    if(managetType=="1"){
                       ...
                       /*if(false){
                           ...
                           $.ajax({
                               url:"${ctx}/resource/resource/checkMiddlewareIp",
                               type:'POST', //
                               async:true,    //或false,是否异步
                               data:{
        ...
        function showOperatingSystem(id) {
            if(id=='9bd43f06feac423cae1dc45fef45406d'){
                $("#accessUserNamePassword").attr("style",'display: none');
			}else{
                $("#accessUserNamePassword").attr("style",'display: ');
			}
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/resource/resource/middleware"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="resource" action="${ctx}/resource/resource/middlewareFormSave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<sys:resourceselect id="resourceType" name="resourceType.id" value="${resource.resourceType.id}" labelName="" labelValue="${resource.resourceType.name}"
									title="资源类型" url="/resourcetype/resourceType/treeDataByCode?code=5"  cssClass="form-control required" notAllowSelectParent="true"/>
			...
			<div id="accessUserNamePassword" >
				<div class="form-group">
					<label class="col-sm-2 control-label">访问用户名：</label>
					<div class="col-sm-8">
						<input id="accessConfigUserName" name= "accessConfigUserName" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">访问密码：</label>
					<div class="col-sm-8">
						<input id="accessConfigPassword" name= "accessConfigPassword" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
			</div>
