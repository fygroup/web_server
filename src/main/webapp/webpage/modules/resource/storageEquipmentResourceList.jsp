...
<head>
	...
	<%@include file="storageResourceList.js" %>
...
<body>
	...
	<div class="panel-heading">
		<h3 class="panel-title">存储设备资源列表</h3>
	</div>
		...
		<div class="col-sm-9 col-md-10" >
			...
			<div id="toolbar">
				<shiro:hasPermission name="resource:resource:add">
					<a id="add" class="btn btn-primary" href="${ctx}/resource/resource/storageEquipmentForm" title="resource"><i class="glyphicon glyphicon-plus"></i> 添加存储设备</a>
				</shiro:hasPermission>
