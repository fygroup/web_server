	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/cpu/cpu"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="cpu" action="${ctx}/cpu/cpu/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<c:if test="${fns:hasPermission('cpu:cpu:edit') || isAdd}">
