		...
		<div class="login-page">
			<div class="row">
				<%--<div class="col-md-4 col-lg-4 col-md-offset-4 col-lg-offset-4">
					<img  class="img-circle" src="${ctxStatic}/common/images/mokaLogo.png" class="user-avatar" />
					<h1>摩卡运维可视化平台</h1>
				...
				<div class="col-md-4 col-lg-4 col-md-offset-4 col-lg-offset-4">
					<img  class="img-circle" src="${ctxStatic}/common/images/mokaLogo.png" class="user-avatar" style="height:66px"/>
					<h2 class="login-title">摩卡运维可视化平台</h2>
					<sys:message content="${message}" showType="1"/>
					<form id="loginForm" role="form" action="${ctx}/login" method="post">
						<div class="form-content">
							<div class="form-group">
							...
							<ul class="pull-right btn btn-info btn-circle" style="background-color:white;height:31px;width:31px">
								<li class="dropdown color-picker" >
									<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
										<span><i class="fa fa-circle"></i></span>
									</a>
						...
						<input type="submit" class="btn btn-white btn-outline btn-lg btn-rounded progress-login col-lg-4" style="width:100%;border-radius: 10px;box-shadow:#fff 1px;color:#fff" value="登录">
						<%--&nbsp;
						<a href="${ctx}/sys/register" class="btn btn-white btn-outline btn-lg btn-rounded progress-login">注册</a>--%>
					</form>
				</div>
