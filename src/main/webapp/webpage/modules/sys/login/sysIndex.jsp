...
<body class="" id="body-box">
	<nav class="navbar topnav-navbar navbar-fixed-top" role="navigation">
		<div class="navbar-header text-center">
			...
			<a class="navbar-brand J_menuItem"  href="${ctx}/home">摩卡运维可视化平台</a>
		</div>
		<div class="collapse navbar-collapse">
			...
			<ul class="nav navbar-nav pull-right navbar-right">	
					...
					<ul class="dropdown-menu pull-right animated fadeIn" role="menu">
						<li class="padder-h-xs">
							<table class="table color-swatches-table text-center no-m-b">
								<tr>
									<td class="text-center colorr"  style="border-top-width: 0">
								...
								<tr>
									...
									<td class="text-center color"  style="border-top-width: 0">
				...
				<li class="dropdown admin-dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" style="padding-top:15px;padding-bottom:15px;">
<%--
						<img src="<c:if test="${fns:getUser().photo == null || fns:getUser().photo==''}">${ctxStatic}/common/images/flat-avatar.png</c:if> <c:if test="${fns:getUser().photo != null && fns:getUser().photo!=''}">${fns:getUser().photo}</c:if>" class="topnav-img" alt="">
--%>
						<span class="hidden-sm">${fns:getUser().name}</span>
					</a>
	...
	<div class="sidenav-outer">
		...
		<%--	<div class="text-center" style="padding-top:10px;">
			...
			<div class="widgets-content">
				<div class="menu" style="top:0;padding-top:1px;">
					<div class="menu-body">
...
<section id="body-container" class="animation">
		...
		<div class="main-container" id="main-container">
						  ...
						  <div class="content-tabs">
							...
							<nav class="page-tabs J_menuTabs">
								<div class="page-tabs-content">
									 <a href="javascript:;" class="active J_menuTab" data-id="${ctx}/home">我的</a>
								</div>
							</nav>
           ...
           <div class="footer">
                <div class="pull-left"><a href="http://www.cloud7.top/" target="_blank">合肥摩卡信息科技发展有限公司</a></div>
            </div>
...
$(function(){
    ...
    $('#hideMenu').click(function () {
		$('#body-box').removeClass('push-right');
        $('#body-box').toggleClass('push-left');
    });
