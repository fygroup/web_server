	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/software/software"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="software" action="${ctx}/software/software/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<c:if test="${fns:hasPermission('software:software:edit') || isAdd}">
