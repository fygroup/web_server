                    ...
                    <form:form id="inputForm" modelAttribute="mailList" action="${ctx}/oa/mailList/save"
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><form:select path="sex" class="form-control" disabled="true">
                                    <form:options items="${fns:getDictList('sex')}" itemLabel="label" itemValue="value"
                                                  htmlEscape="false"/>
                                </form:select></td>
                            </tr>
                            <tr>
                                <td class="active"><label class="pull-right">部门:</label></td>
                                <td><form:input path="orgName" htmlEscape="false" maxlength="100"
                                                class="form-control" readonly="true"/></td>
                            </tr>
                            <tr>
                                <td class="active"><label class="pull-right">地址:</label></td>
