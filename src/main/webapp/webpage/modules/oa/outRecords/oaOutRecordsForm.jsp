			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title">
						<a class="panelButton" href="${ctx}/oa/oaOutRecords"><i class="ti-angle-left"></i> 返回</a>
					</h3>
				</div>
				<div class="panel-body">
					<form:form id="inputForm" modelAttribute="oaOutRecords" action="${ctx}/oa/oaOutRecords/save" method="post" class="form-horizontal">
						<form:hidden path="id"/>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<div class='input-group form_datetime' id='entryTime'>
									<input type='text'  name="entryTime" class="form-control required"  value="<fmt:formatDate value="${oaOutRecords.entryTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<div class='input-group form_datetime' id='departureTime'>
									...
									<input type='text'  name="departureTime" class="form-control equalTo  value="<fmt:formatDate value="${oaOutRecords.departureTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
									<span class="input-group-addon">
										<span class="glyphicon glyphicon-calendar"></span>
									</span>
								</div>
