                ...
                <div class="panel-body">
                    <form:form id="inputForm" modelAttribute="knowledgeBase" action="${ctx}/oa/knowledgeBase/save" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <form:input path="cause" htmlEscape="false" maxlength="200" class="form-control required"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <form:textarea path="plan" htmlEscape="false" rows="6" maxlength="2000" class="form-control required"/>
                            </div>
                        </div>
                        ...
                        <shiro:hasPermission name="oa:knowledgeBase:edit">
