	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/monitor/patrol"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="patrol" action="${ctx}/monitor/patrol/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
				<div class="form-group">
					<label class="col-sm-2 control-label"><font color="red">*</font>巡检名称：</label>
					<div class="col-sm-10">
				...
				<%--</div>--%>
				<div class="form-group">
					<label class="col-sm-2 control-label"><font color="red">*</font>巡检周期：</label>
					<div class="col-sm-10">
						<%--<form:input path="checkPeriod" htmlEscape="false"    class="form-control required isCronExpress"/>--%>
							<form:select path="cronExpression" class="form-control required">
								<form:option value="" label=""/>
								<form:options items="${fns:getDictList('checkPeriod')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
							</form:select>
						<div style="margin-top: 10px;" class="alert alert-info alert-dismissable">
							&nbsp;<strong>Cron释义：</strong><br>
							&nbsp;0 0 17 * * ?  每天下午5点执行<br>
							&nbsp;0 0 0 ? * FRI 每周周五0点执行<br>
							&nbsp;0 0 0 1 * ?   每月1号0点执行<br>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label"><font color="red">*</font>巡检类型：</label>
					<div class="col-sm-10">
						<form:select path="checkType" class="form-control required">
							<form:option value="" label=""/>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label"><font color="red">*</font>巡检内容：</label>
					<div class="col-sm-10">
						<sys:checkbox id="checkContent" name="checkContent" items="${fns:getDictList('checkContent')}" values="${patrol.checkContent}" cssClass="i-checks "/>
					</div>
				</div>
				...
				<%--<div class="form-group">--%>
					<%--<label class="col-sm-2 control-label">巡检通知用户：</label>--%>
					<%--<div class="col-sm-10">--%>
