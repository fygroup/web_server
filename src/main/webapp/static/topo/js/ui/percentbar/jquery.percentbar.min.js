(function ($) {
    var defaults = null, classNames = null, methods = null;
    defaults = {
        value: 0,
        textColor: null,
        textSuffix: "%",
        ...
        _init: function (options) {
            ...
            return this.each(function () {
                var $this = $(this), opts = methods.options.call($this, null);
                if (opts&&opts.isShowText) {
                    $this.children("." + classNames.text).html(value + opts.textSuffix);
                    $this.children("." + classNames.image).stop(true, true).animate({width: value + "%"}, opts.animateTime, function () {
