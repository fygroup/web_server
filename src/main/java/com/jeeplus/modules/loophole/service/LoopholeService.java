package com.jeeplus.modules.loophole.service;
...
public class LoopholeService extends CrudService<LoopholeMapper, Loophole> {

	@Autowired
	private LoopholeMapper loopholeMapper;

	public Loophole getTopLoophole(String id) {
		return loopholeMapper.getTopLoophole(id);
	}
