package com.jeeplus.modules.update.storageequipment.memory;
...
public class StorageEquipmentMemoryByV1V2 implements UpdateService{
    private  MemoryService memoryService= (MemoryService)SpringBeanUtils.getBeanByClass(MemoryService.class);
    private String uuid="6dd6e7bsdfaf48a3a4430907cd78f4a0";
