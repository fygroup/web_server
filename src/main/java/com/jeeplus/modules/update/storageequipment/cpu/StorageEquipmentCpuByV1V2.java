package com.jeeplus.modules.update.storageequipment.cpu;
...
public class StorageEquipmentCpuByV1V2 implements UpdateService {

    private CpuService cpuService= (CpuService) SpringBeanUtils.getBeanByClass(CpuService.class);
    private String uuid="1fe4ec3c3233dsfsd5b95d77cc63sdswb38";
