...
public class SangforIpsMemoryByV1V2 implements UpdateService {


    private MemoryService memoryService= (MemoryService)SpringBeanUtils.getBeanByClass(MemoryService.class);
    private String uuid="b1f6d1b86ba24365bae7fd86c5082317";
    ...
    public  void updateIndicator(Resource resource) {
        synchronized(uuid.intern()) {
            ...
            if (CheckObject.checkList(list)) {
                ...
                memoryService.saveList(null, list, resource, memoryUsedRate,physicalMemory,virtualMemory);
            }
