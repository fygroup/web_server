...
public class SangforIpsCpuByV1V2 implements UpdateService {

    private CpuService cpuService= (CpuService) SpringBeanUtils.getBeanByClass(CpuService.class);
    private String uuid="af0a174b4f424bc09a8cc0db83a64105";
        ...
        synchronized(uuid.intern()) {
            ...
            if (CheckObject.checkList(cpuList)) {
                ...
                if(CheckObject.checkList(list)) {
                    ...
                    cpuUsedRate.setUsedRate(String.valueOf(cpuUsedPercent / list.size()));
                    cpuService.saveList(null, list, resource, cpuUsedRate);
