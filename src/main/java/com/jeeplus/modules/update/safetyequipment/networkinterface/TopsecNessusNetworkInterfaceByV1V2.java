package com.jeeplus.modules.update.safetyequipment.networkinterface;
...
import com.jeeplus.modules.collect.networkequipment.others.networkinterface.NetworkInterfaceIndicatorCalculateNessus;
 ...
 */
public class TopsecNessusNetworkInterfaceByV1V2 implements UpdateService {
    ...
    private String uuid="b86770f3e02b46148da7aa68xz85835a";
    ...
    public  void updateIndicator(Resource resource) {
        synchronized(uuid.intern()) {
            ...
            if(CheckObject.checkList(list)) {
                ...
                networkInterfaceService.saveList(rateList,null,list,resource.getId());
            }
