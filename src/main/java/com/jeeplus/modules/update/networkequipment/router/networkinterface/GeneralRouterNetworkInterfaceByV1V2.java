package com.jeeplus.modules.update.networkequipment.router.networkinterface;
...
public class GeneralRouterNetworkInterfaceByV1V2 implements UpdateService {
    ...
    private String uuid="9fdf5971a9e64fac8bbffec2825a5f97";
