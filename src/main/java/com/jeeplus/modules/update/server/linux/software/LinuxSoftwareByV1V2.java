package com.jeeplus.modules.update.server.linux.software;
...
public class LinuxSoftwareByV1V2 implements UpdateService {

    private SoftwareService softwareService= (SoftwareService) SpringBeanUtils.getBeanByClass(SoftwareService.class);
    private String uuid="f805bba6884749839adae78150245025";
