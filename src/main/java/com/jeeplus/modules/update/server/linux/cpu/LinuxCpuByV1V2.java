package com.jeeplus.modules.update.server.linux.cpu;
...
public class LinuxCpuByV1V2 implements UpdateService {

    private CpuService cpuService= (CpuService) SpringBeanUtils.getBeanByClass(CpuService.class);
    private String uuid="1fe4ec3c405042d5b95d77cc6324cb38";
