package com.jeeplus.modules.update.server.linux.disk;
...
public class LinuxDiskByV1V2 implements UpdateService {

    private DiskService diskService= (DiskService) SpringBeanUtils.getBeanByClass(DiskService.class);
    private String uuid="47c9f2e5165347bcb9186042d9750b2d";
