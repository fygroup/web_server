...
public class SystemService extends BaseService implements InitializingBean {
	...
	public Page<User> findopsUser(Page<User> page, User user) {
		dataRuleFilter(user);
		// 设置分页参数
		user.setPage(page);
		// 执行分页查询
		page.setList(userMapper.findersList(user));
		return page;
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	@Transactional(readOnly = false)
	public int updateMyViewSort(String id,String sort){
		return  userMapper.updateMyViewSort(id,sort);

	}

	public String getUserViewSort(String id){
		return  userMapper.getUserViewSort(id);
	}
}
