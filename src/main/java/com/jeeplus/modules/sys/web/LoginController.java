...
public class LoginController extends BaseController{
	...
	public String home(HttpServletRequest request, HttpServletResponse response, Model model) throws IOException {
		...
		model.addAttribute("myViewSort", systemService.getUserViewSort(user.getId()));
	 ...
	 * @throws IOException
	 */
	@RequestMapping(value = "${adminPath}/topologicalGraph")
	public String topologicalGraph(HttpServletRequest request, HttpServletResponse response, Model model) throws IOException {

		return "modules/sys/topologicalGraph/home";
