...
public class UserController extends BaseController {
	...
	//运维人员
	@RequiresPermissions("sys:user:index")
	@RequestMapping(value = "opsSelect")
	public String opsSelect(boolean isMultiSelect, Model model) {
		model.addAttribute("isMultiSelect", isMultiSelect);
		return "modules/common/opsSelect";
	}
	...
	public Map<String, Object> opslist(User user, HttpServletRequest request, HttpServletResponse response, Model model) {
		Page<User> page = systemService.findopsUser(new Page<User>(request, response), user);
		return getBootstrapData(page);
	}
...
//				currentUser.setPhoto(user.getPhoto());
	...
	public String imageUpload( HttpServletRequest request, HttpServletResponse response,MultipartFile file) throws IllegalStateException, IOException {
        ...
        if (!file.isEmpty()) {  
    			...
    			systemService.updateUserInfo(currentUser);
    			return request.getContextPath()+realPath + file.getOriginalFilename();
        }  
