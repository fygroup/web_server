package com.jeeplus.modules.collect.server.linux.networkinterface;
...
public class NetworkInterfaceIndicatorCalculateLinuxByV1V2 {
        ...
        getSoftwareListIteration(modifyTimeList, "1.3.6.1.2.1.25.6.3.1.5");*/
            ...
            if (nameList.size() > 0 ) {
                for (String value : nameList) {
                    ...
                    if(!"6".equals(typeList.get(i))||"".equals(macList.get(i))){
                        i++;
                        continue;
                    }
 ...
 */
        public static void main(String[] args) throws Exception {
            try {
             GetNetworkInterfaceInfo("192.168.1.1", "asus","161", "500", "4",1);
