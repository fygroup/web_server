package com.jeeplus.modules.collect.networkequipment.firewall;

import com.jeeplus.common.utils.SnmpUtil;
import com.jeeplus.common.utils.Transformation;

public class ConnectionsIndicatorCalculateFirewall {
    ...
    public static void main(String[] args) throws Exception {
        try {
            System.out.println(getCurrentConnections("139.0.31.251", "public","161", "500", "2",1));
            System.out.println(getCps("139.0.31.251", "public","161", "500", "2",1));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
