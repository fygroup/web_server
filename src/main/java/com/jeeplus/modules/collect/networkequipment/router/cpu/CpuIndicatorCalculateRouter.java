...
public class CpuIndicatorCalculateRouter {
     ...
     * 获取CPU利用率 百分比
     */
    public static List<ResourceOidValue> getCpuUse(String ip, String community, String port, String timeout, String retries, int version) {
        try {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            getCpuUse("192.168.1.1", "asus","161", "500", "4",1);
