package com.jeeplus.modules.collect.networkequipment.others.networkinterface;
...
/**
 * 天融信漏洞扫描NetworkInterface
 *
 * @author huanglei
 * @email  616754909@qq.com
 * @version 2018-6-11 12:52
 */
public class NetworkInterfaceIndicatorCalculateNessus {
        ...
        getSoftwareListIteration(modifyTimeList, "1.3.6.1.2.1.25.6.3.1.5");*/
            ...
            if (nameList.size() > 0 ) {
                for (String value : nameList) {
                    if("Null0".equals(hexToChinese(value))||!("6".equals(interfaceTypeList.get(i))||"117".equals(interfaceTypeList.get(i)))){
                        i++;
                        continue;
                    }
    ...
    public static void main(String[] args) throws Exception {
        try {
            GetNetworkInterfaceInfo("139.0.31.251", "public","161", "500", "4",1);
