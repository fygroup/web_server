...
public class NetworkInterfaceIndicatorCalculateHuawei {

    private static Snmp snmp = null;
    private static CommunityTarget target = null;
    private static PDU responsepdu = new PDU();
    private static String uuid="a8cf23d117bb43999fsfe4360a25e87bb";
 ...
 */
        public static void main(String[] args) throws Exception {
            try {
             GetNetworkInterfaceInfo("192.168.0.107", "public","161", "500", "4",1);
