package com.jeeplus.modules.collect.networkequipment.exchange.networkinterface;
...
public class NetworkInterfaceIndicatorCalculateH3C {

    private static Snmp snmp = null;
    private static CommunityTarget target = null;
    private static PDU responsepdu = new PDU();
    private static String uuid="a8cf23d117bb439bsrfsfe4360a25e87bb";
    ...
    public static List<Map<String, Object>> GetNetworkInterfaceInfo(String ip, String community, String port, String timeout, String retries,int version) {
        //synchronized (uuid.intern()) {
            ...
            // 1.3.6.1.2.1.2.2.1.7
            // 1.3.6.1.2.1.2.2.1.8   接口当前操作状态[up|down]   [1|2]
        ...
        getSoftwareListIteration(modifyTimeList, "1.3.6.1.2.1.25.6.3.1.5");*/
                ...
                int i = 0;
                if (nameList.size() > 0) {
                    for (String value : nameList) {     //修改为 1和136类型不取
 ...
 */
        public static void main(String[] args) throws Exception {
            try {
             GetNetworkInterfaceInfo("139.0.1.254", "public","161", "500", "4",1);
