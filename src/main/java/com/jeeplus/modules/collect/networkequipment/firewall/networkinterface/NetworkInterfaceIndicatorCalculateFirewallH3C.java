...
public class NetworkInterfaceIndicatorCalculateFirewallH3C {
       ...
       // 1.3.6.1.2.1.2.2.1.0  get接口数目
        ...
        if (nameList.size() > 0 ) {
            for (String value : nameList) {
                if("Null0".equals(hexToChinese(value))||!("6".equals(interfaceTypeList.get(i))||"161".equals(interfaceTypeList.get(i))||"117".equals(interfaceTypeList.get(i)))){
                    i++;
                    continue;
                }
 ...
 */
        public static void main(String[] args) throws Exception {
            try {
             GetNetworkInterfaceInfo("139.2.0.138", "public","161", "500", "4",1);
