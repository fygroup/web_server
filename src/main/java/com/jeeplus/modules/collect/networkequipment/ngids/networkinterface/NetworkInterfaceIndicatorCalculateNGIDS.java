package com.jeeplus.modules.collect.networkequipment.ngids.networkinterface;
 ...
 */
public class NetworkInterfaceIndicatorCalculateNGIDS {
        ...
        getSoftwareListIteration(modifyTimeList, "1.3.6.1.2.1.25.6.3.1.5");*/
            ...
            if (nameList.size() > 0 ) {
                for (String value : nameList) {
                    if("Null0".equals(hexToChinese(value))||!"6".equals(interfaceTypeList.get(i))){
                        i++;
                        continue;
                    }
    ...
    public static void main(String[] args) throws Exception {
        try {
            GetNetworkInterfaceInfo("192.168.0.109", "public","161", "500", "4",1);
