package com.jeeplus.modules.collect.networkequipment.router.networkinterface;
...
public class NetworkInterfaceIndicatorCalculateRouterHuawei {
    ...
    public static List<Map<String, Object>> GetNetworkInterfaceInfo(String ip, String community, String port, String timeout, String retries,int version) {
        ...
        List<String> interfaceTypeList = new ArrayList<String>();          //MAC
       ...
       // 1.3.6.1.2.1.2.2.1.0  get接口数目
        ...
        pdu.setType(PDU.GETBULK);
         ...
         getSoftwareListIteration(nameList, "1.3.6.1.2.1.2.2.1.2");
            ...
            getSoftwareListIteration(interfaceTypeList, "1.3.6.1.2.1.2.2.1.3");
         responsepdu.clear();
        ...
        if (nameList.size() > 0 ) {
            for (String value : nameList) {
                if("null0".equals(hexToChinese(value).toLowerCase())||!("117".equals(interfaceTypeList.get(i))||"6".equals(interfaceTypeList.get(i)))){
                    i++;
                    continue;
                }
                networkInterfaceMap = new HashMap<String, Object>();
                networkInterfaceMap.put("name", hexToChinese(value));
                //System.out.println(hexToChinese(value));
                // 输出容量
                float c = (float) Transformation.null2Float(capacityList.get(i)) / 1000 / 1000 ;
                DecimalFormat df = new DecimalFormat("0.00");// 格式化小数，不足的补0
                networkInterfaceMap.put("interfaceType", interfaceTypeList.get(i));
 ...
 *
 * @author linwang
 * @createTime 2014-7-12 inputByte=991412859, name=GigabitEthernet3/0/1
 *                       inputByte=1693208750, name=GigabitEthernet3/0/1
 * @param args
 */
        public static void main(String[] args) throws Exception {
            try {
             GetNetworkInterfaceInfo("17.16.0.15", "public123","161", "500", "4",1);
