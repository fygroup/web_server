package com.jeeplus.modules.collect.networkequipment.firewall.networkinterface;
...
public class NetworkInterfaceIndicatorCalculateFirewallHuawei {
       ...
       // 1.3.6.1.2.1.2.2.1.0  get接口数目
        ...
        if (nameList.size() > 0 ) {
            for (String value : nameList) {
                if("null0".equals(hexToChinese(value).toLowerCase())||!("16711682".equals(interfaceTypeList.get(i))||"6".equals(interfaceTypeList.get(i))||"117".equals(interfaceTypeList.get(i)))){
                    i++;
                    continue;
                }
 ...
 */
        public static void main(String[] args) throws Exception {
            try {//D5M4Dw@r
             GetNetworkInterfaceInfo("17.16.2.21", "D5M4Dw@r","161", "500", "4",1);
