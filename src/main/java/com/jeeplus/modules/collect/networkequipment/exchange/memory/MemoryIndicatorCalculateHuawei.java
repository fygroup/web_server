...
public class MemoryIndicatorCalculateHuawei {
            ...
            if(result==null){
                ...
                if(CheckObject.checkList(list)){
                    ...
                    for(int i = 0; i < list.size(); ++i) {
                        try {
                            num = Transformation.null2Double(list.get(i).getValue());
                            if(num > 0) {
                                memLoad = (float)num;
                                ++num;
                            }
    ...
    public static void main(String[] args) throws Exception {
        try {
            System.out.println(getMemoryUsedPercent("17.16.2.1", "D5M4Dw@r","161", "500", "2",1));
