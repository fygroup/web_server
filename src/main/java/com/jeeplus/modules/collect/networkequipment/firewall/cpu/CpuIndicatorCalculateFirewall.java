...
public class CpuIndicatorCalculateFirewall {



    private static String oidval = "1.3.6.1.4.1.14331.5.5.1.4.5";
    ...
    public static void main(String[] args) throws Exception {
        try {
            System.out.println( getCpu("139.0.31.251", "public","161", "500", "4",1));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
