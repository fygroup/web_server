...
public class Global {
	 ...
	 * 属性文件加载对象
	 */
	private static PropertiesLoader loader = new PropertiesLoader("/properties/moka.properties");
...
//		System.out.println("userfiles.basedir: " + dir);
	...
	public static void modifyConfig(String key, String value) {
		try {
			...
			String path = Global.class.getResource("/properties/moka.properties").getPath();
	...
	public static Properties getProperties(){
		...
		try {
			Reader reader = Resources.getResourceAsReader("/properties/moka.properties");
			prop.load(reader);
		} catch (Exception e) {
			return null;
		}
