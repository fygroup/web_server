...
public interface BaseMapper<T> {
	...
	/**
	 * 查询运维人员数据列表，如果需要分页，请设置分页对象，如：entity.setPage(new Page<T>());
	 * @param entity
	 * @return
	 */
	public List<T> findersList(T entity);
	...
	//返回String
	@Select("${sql}")
	public String qexecSelectSql(@Param(value="sql")String sql);

	@Update("${sql}")
	public void execUpdateSql(@Param(value="sql")String sql);

	@Update("${sql}")
	public String uexecUpdateSql(@Param(value="sql")String sql);
